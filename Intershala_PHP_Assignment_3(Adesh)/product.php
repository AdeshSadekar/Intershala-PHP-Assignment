<?php
	require('C:\wamp64\www\VirtualHost Project\common.php');
?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		<?php
			require('C:\wamp64\www\VirtualHost Project\Header.php');
		    require('C:\wamp64\www\VirtualHost Project\check-if-added.php');
		?>
			...
			<div class="row text-center">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Olympus DSLR</h3>
							<p>Price: <i class="fa fa-rupee"></i> 80000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="Login.php" type="button" class="btn btn-primary btn-block">Add to cart</a>
							<?php }else{ ?>
		...
		<?php
			require('C:\wamp64\www\VirtualHost Project\footer.php');
		?>
	</body>
</html>